...
class Eval():
    ...
    def TestClassifacationKMeans(self, embedding, label):
    ...
    def E_Clasting_Kmeans(self):
        ...
        return self.TestClassifacationKMeans(self.latent, self.label.astype(np.int32))

...
CUDA_VISIBLE_DEVICES=0 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
CUDA_VISIBLE_DEVICES=1 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
CUDA_VISIBLE_DEVICES=2 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
CUDA_VISIBLE_DEVICES=3 wandb agent cairi/DLME_ECCV2022/csbvnmpa &
CUDA_VISIBLE_DEVICES=4 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
CUDA_VISIBLE_DEVICES=5 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
CUDA_VISIBLE_DEVICES=6 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
CUDA_VISIBLE_DEVICES=7 wandb agent cairi/DLME_ECCV2022/csbvnmpa 
# CUDA_VISIBLE_DEVICES=4 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
# CUDA_VISIBLE_DEVICES=5 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
# CUDA_VISIBLE_DEVICES=6 wandb agent cairi/DLME_ECCV2022/csbvnmpa & 
# CUDA_VISIBLE_DEVICES=7 wandb agent cairi/DLME_ECCV2022/csbvnmpa

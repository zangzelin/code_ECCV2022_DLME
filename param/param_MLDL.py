...
def GetParamswishroll():
    ...
    # parser.add_argument('--epsilon', type=float, default=0.37, )
    parser.add_argument('--K', type=int, default=8, )
    parser.add_argument('--regular_B', type=float, default=3.0, )
    parser.add_argument('--chang_start', type=float, default=500.0, )
    parser.add_argument('--chang_end', type=float, default=1000.0, )
    parser.add_argument('--rate_push', type=float, default=5.0, )
...
def GetParamSphere5500():
    ...
    parser.add_argument('--ve', type=float, default=100.0, )
    parser.add_argument('--Dec', type=bool, default=False, )
    parser.add_argument('--NetworkStructure', type=list, default=[-1, 50, 25, 2], )
    parser.add_argument('--pow', type=float, default=2.0, )
    parser.add_argument('--model_type', type=str, default='mlp', )
    ...
    parser.add_argument('--chang_start', type=float, default=500.0, )
    parser.add_argument('--chang_end', type=float, default=1000.0, )
    parser.add_argument('--rate_push', type=float, default=0.0, )
...
def GetParamcoil20():
    ...
    parser.add_argument('--pow', type=float, default=2.0, )
    parser.add_argument('--model_type', type=str, default='mlp', )
    # parser.add_argument('--epsilon', type=float, default=1.6, )
...
#     # train param
#     parser.add_argument('--batch_size', type=int, default=1440//2, )

...
def GetParamOTU():
    ...
    parser.add_argument('--variancethreshold', type=float, default=3.5, )
...
def GetParamOTU2():
    ...
    parser.add_argument('--variancethreshold', type=float, default=3, )
    parser.add_argument('--vs', type=float, default=0.001, )
    parser.add_argument('--ve', type=float, default=100.0, )
    parser.add_argument('--Dec', type=bool, default=False, )
    parser.add_argument('--NetworkStructure', type=list, default=[-1, 600, 500, 400, 300, 200, 2], )
...
def GetParamswishroll():
    ...
    parser.add_argument('--pow', type=float, default=2.0, )
    parser.add_argument('--model_type', type=str, default='mlp', )
    parser.add_argument('--variancethreshold', type=float, default=0.0, )
    parser.add_argument('--num_choose', type=int, default=0, )
...
def GetParamDigits():
    ...
    parser.add_argument('--vs', type=float, default=1e-3, )
...
def GetParamcoil20():
    ...
    parser.add_argument('--NetworkStructure', type=list, default=[-1, 600, 500, 400, 300, 200, 2], )
    parser.add_argument('--variancethreshold', type=float, default=0.0, )
    parser.add_argument('--num_choose', type=int, default=-1, )
    parser.add_argument('--pow', type=float, default=6.0, )
...
def GetParamMnistL():
    ...
    parser.add_argument('--pow', type=float, default=8.0, )
    parser.add_argument('--model_type', type=str, default='mlp', )
    parser.add_argument('--variancethreshold', type=float, default=0.0, )
    parser.add_argument('--num_choose', type=int, default=-1, )
...
def GetParamMnistLD2():

    parser = argparse.ArgumentParser(description='*** author')
    parser.add_argument('--name', type=str, default='emnistLD2', )
    parser.add_argument('--loadfromjson', type=str, default='', )

    # data set param
    parser.add_argument('--method', type=str, default='LISv2_mm', )
    parser.add_argument('--data_name', type=str, default='mnistD2', )
    parser.add_argument('--data_trai_n', type=int, default=60000, )
    # model param
    parser.add_argument('--metric', type=str, default="euclidean", )
    parser.add_argument('--vinput', type=float, default=100, )
